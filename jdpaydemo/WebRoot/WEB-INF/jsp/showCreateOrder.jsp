...
<body>
	<form action="${ctx}/createOrder.htm" method="post" target="_blank">
		<div class="content">
			<div class="content_0">
				<label>version:</label>
				...
				<input type="text" name="payMerchant" value="${payMerchant}"> <br />
				<label>device:</label>
				...
				<input type="text" name="userType" value="BIZ"> <br />
				<label>userId:</label>
				<input type="text" name="userId" value=""> <br />
				<label>expireTime:</label>
				<input type="text" name="expireTime" value="600"> <br />
				...
				<input type="text" name="tradeType" value="QR"> <br />
